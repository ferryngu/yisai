...
func fe_http_post(url:String, handler:fe_http_post_handler!, memsize:Int, timeout:Int, param:[String])->String! {
...
*/
func fe_http_post_string(host:String, uri:String,params:[String])->String! {
...
func fe_http_post_json_std(host:String, uri:String,params:[String]) -> NSDictionary!  {
